...
export default function HeroSection() {
  ...
  return (
    // <div className="bg-[url('./assets/iitb.webp')] min-h-screen bg-cover" >
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-16 sm:py-24 lg:py-36">
          ...
          <div className="text-center">
            <h1 className="text-balance text-4xl font-lexend tracking-tight text-gray-50 sm:text-6xl">
              Welcome to Vitruvians
            </h1>
